...
template <typename DataSet>
void run_baseline(unordered_map<uint64_t, uint64_t>& table, DataSet& dataset, ofstream& of) {
...
int main(int argc, char* argv[]) {
    ...
    if (type == "number") {
        vector<pair<uint64_t, uint64_t>> dataset =
            generate_number_dataset(num_keys, table_capacity);
        ...
        // vector<pair<string, string>> dataset =
        //     generate_string_dataset(num_keys, table_capacity);
        // if (hashtable == "unordered_map") {
